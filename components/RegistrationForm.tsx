...
export function RegistrationForm({ onSuccess }: RegistrationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        // The invitation card is NOT delivered automatically anymore —
        // identity is verified manually by the admin over WhatsApp,
        // who then sends the person their card link directly.
        setSubmitted(true);
      } else {
