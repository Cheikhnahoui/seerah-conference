    ...
    try {
      const res = await fetch('/api/updates', {
        ...
        body: JSON.stringify({
          ...
          is_pinned: isPinned,
          is_important_notice: isImportantNotice,
        }),
      });
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            style={inputStyle}
            placeholder={isScholar ? 'مثال: الشيخ محمد الأمين الشنقيطي' : 'عنوان المنشور'}
          />
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg text-sm outline-none"
                  style={inputStyle}
                  placeholder="مثال: أستاذ الفقه المقارن"
                />
              </div>
            </div>
        ...
        <div>
          ...
          <textarea
            ...
            style={inputStyle}
            placeholder={isScholar ? 'نبذة عن العالم/الشيخ...' : 'اكتب محتوى الخبر أو الإعلان كاملاً...'}
          />
        </div>
        ...
        <div className="rounded-xl p-4 space-y-3" style={{ background: 'var(--color-bg)', border: '1px solid var(--color-border)' }}>
          <label className="flex items-center justify-between text-sm">
            <span style={{ color: 'var(--color-text)' }}>نشر المنشور فوراً</span>
        ...
        >
          {submitting ? 'جارٍ الحفظ...' : 'حفظ المنشور'}
        </button>
      </form>
    </div>
  );
