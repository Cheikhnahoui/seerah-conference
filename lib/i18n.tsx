...
const translations = {
  ar: {
    ...
    honor_text: 'فضيلة الشيخ محمد الحافظ النحوي يتشرف بحضوركم الكريم',
    invitation_title: 'أحباب رسول الله صلى الله عليه وسلم',
    invitation_body: 'أنتم مدعوون لحضور أمسية مديحية برعاية السيد عمدة عرفات ضمن موسم سيرة ونصرة الحبيب المصطفى صلى الله عليه وسلم المنظم من قبل التجمع الثقافي الإسلامي تخليدا لذكرى مولد نبي الرحمة سيدنا وقرة أعيننا محمد صلى الله عليه وسلم.',
    opening: 'الافتتاح',
