...
const translations = {
  ar: {
    ...
    honor_text: 'تحت الرعاية السامية لفخامة رئيس الجمهورية السيد محمد ولد الشيخ الغزواني، يتشرف فضيلة الشيخ محمد الحافظ النحوي رئيس التجمع الثقافي الإسلامي بدعوة السيد(ة)\u00A0:',
    invitation_title: '',
    invitation_body: 'لحضور الجلسات العلمية للمؤتمر الدولي الـ39 لسيرة ونصرة الحبيب المصطفى صلى الله عليه وسلم',
    opening: 'الافتتاح',
  ...
  fr: {
    ...
    invitation_body: "Pour assister aux sessions scientifiques du 39ème Congrès International sur la Sîra et le soutien au Bien-Aimé Al-Mustafa, paix et bénédictions sur lui.",
    opening: 'Ouverture',
